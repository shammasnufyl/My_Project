...
namespace My_Project
{
    public partial class EditProduct : System.Web.UI.Page
    {
        ...
        {
            string selall = "select * from Product";
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            string del = "delete from Product where Pdt_Id=" + getid + "";
            obj.fn_Nonquery(del);
            gridBind();
        }
        ...
        protected void GridView1_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            string upd = "update Product set Pdt_Name='" + txtname.Text + "', Pdt_Desc='" + txtdesc.Text + "',Pdt_Price='" + txtprice.Text + "',Pdt_Stock='" + txtstock.Text + "' where Pdt_Id=" + getid + "";
            obj.fn_Nonquery(upd);
            gridBind();
        }
    }
